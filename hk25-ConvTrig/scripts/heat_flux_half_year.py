...
TIME = "PT3H"
ANALYSIS_TIME = (
    np.datetime64("2020-02-01T00:00:00"), np.datetime64("2020-08-01T00:00:00")
    )
...
# vars = ["hflsd", "hfssd"]# latent heat, sensible heat, precipitation
vars = ['hflsd']
...
#%%
# save
var_in_trigger_area_ano.to_netcdf("/work/mh0033/m300883/hk25_data/PT3H_latent_heatflux_before_halfyear.nc")
