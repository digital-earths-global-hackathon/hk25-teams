...
client, cluster = scluster.init_dask_slurm_cluster(
    scale = 5, processes = 20, walltime="04:00:00", memory="200GB", dash_address=1919
)
...
vars = ["hflsd"]# latent heat, sensible heat, precipitation
...
#%%
# save
var_in_trigger_area_ano.to_netcdf("/work/mh0033/m300883/hk25_data/PT3H_latentheat_before_oneyear.nc")
